...
async function errorWinOk(message) {
    let div = document.createElement("div")
    div.setAttribute("style", "position: absolute;top: 30%;left: 35%;width: 30%;min-height: 20%;background: #d3dbf0;display: flex;flex-direction: column;justify-content: space-between;padding: 10px;border-radius: 12px;align-items: center;border: 1px solid;")
    div.innerHTML = `
    <div style="color: #ff6d6d; font-size: 15px; font-weight: 600;">Ошибка!</div>
    <div style="width: 100%; min-height: 61%; overflow-wrap: break-word;">${message}</div>
